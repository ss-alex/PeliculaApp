...
open class PACarouselFlowLayout: UICollectionViewFlowLayout {
    ...
    fileprivate func updateLayout() {
        ...
        let xInset = (collectionSize.width - self.itemSize.width) / 15
    ...
    fileprivate func transformLayoutAttributes(_ attributes: UICollectionViewLayoutAttributes) -> UICollectionViewLayoutAttributes {
        ...
        let collectionCenter = isHorizontal ? collectionView.frame.size.width/6 : collectionView.frame.size.height/6
